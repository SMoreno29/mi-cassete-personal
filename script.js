const mixtape = [
    ...
    { url: "https://open.spotify.com/embed/track/6ZIdBibfqeFGq3AbkzHU1X", message: "Mensaje aquí...", author: "Tu nombre" }, // contigo - los concorde
    { url: "https://open.spotify.com/embed/track/4QhZMvnoOxP6Ra73Ergy1f", message: "Mensaje aquí...", author: "Tu nombre" }, // si no te tengo a ti - hombres G
    ...
    { url: "https://open.spotify.com/embed/track/74RbuwSLTpIKA0RqOo5msR", message: "Mensaje aquí...", author: "Tu nombre" }, // sismo - division minuscula
    { url: "https://open.spotify.com/embed/track/6JxsIadCWYVwOBQymaYMcZ", message: "Mensaje aquí...", author: "Tu nombre" }, // fragil - alison
    { url: "https://open.spotify.com/embed/track/4OxT0CsUF1GMW1DGMdqhMX", message: "Mensaje aquí...", author: "Tu nombre" }, // tratame mal - bipoxx
    { url: "https://open.spotify.com/embed/track/6UAa6a7abJYiEj9ggLsfb8", message: "Mensaje aquí...", author: "Tu nombre" }, // ya no es lo mismo - sin censura
    ...
    { url: "https://open.spotify.com/embed/track/35SRuRfp5BvD1yArmXKNHO", message: "Mensaje aquí...", author: "Tu nombre" }, // i just threw out the love of my dreams - weezer
    { url: "https://open.spotify.com/embed/track/1ndGB6rvxKYN9seCYO1dTF", message: "Mensaje aquí...", author: "Tu nombre" }, // zephyr song - RHCP
    { url: "https://open.spotify.com/embed/track/2aibwv5hGXSgw7Yru8IYTO", message: "Mensaje aquí...", author: "Tu nombre" }, // snow (hey oh) - RHCP
    ...
    { url: "https://open.spotify.com/embed/track/7EdO50H2O5QuqAcEGCKeFY", message: "Mensaje aquí...", author: "Tu nombre" }, // stone - born without bones
    { url: "https://open.spotify.com/embed/track/3UwRnIg1UzkO7RI0luhN9O", message: "Mensaje aquí...", author: "Tu nombre" }, // cheap fun - born without bones
    { url: "https://open.spotify.com/embed/track/5iZw5AzGiQx5rmmocWBFOz", message: "Mensaje aquí...", author: "Tu nombre" }, // the night i drove alone - citizen
    { url: "https://open.spotify.com/embed/track/26iZhZ3qf0k47LrnLNyUdG", message: "Mensaje aquí...", author: "Tu nombre" }, // let me breathe whats mine - scumbag monday
    ...
    { url: "https://open.spotify.com/embed/track/0k5N2FhF1zszcfHX1EOfFc", message: "Mensaje aquí...", author: "Tu nombre" }, // liar´s love - title fight
    { url: "https://open.spotify.com/embed/track/63iO8MvYbHlGJXi6bAtTcs", message: "Mensaje aquí...", author: "Tu nombre" }, // make tonight - emanuel
    { url: "https://open.spotify.com/embed/track/6JfwpTVJAgiJifM1JrGFsC", message: "Mensaje aquí...", author: "Tu nombre" }, // november - silverstein
    { url: "https://open.spotify.com/embed/track/0DKNNR9iDjwfCEpMiFXMJq", message: "Mensaje aquí...", author: "Tu nombre" }, // until the day i die - story of the year
    { url: "https://open.spotify.com/embed/track/5QYwIidpvmcqBWYx6hy8AT", message: "Mensaje aquí...", author: "Tu nombre" }, // it´ll be ok - limp bizkit
    { url: "https://open.spotify.com/embed/track/7HKRWMTErKh56EIBeFcmdf", message: "Mensaje aquí...", author: "Tu nombre" }, // seize the day - avenged sevenfold
    { url: "https://open.spotify.com/embed/track/2Hy81a71pPf5lPWTq1o8ub", message: "Mensaje aquí...", author: "Tu nombre" }, // lip gloss and black - atreyu
    { url: "https://open.spotify.com/embed/track/4MpC6vTWuzT8ihH50DVbem", message: "Mensaje aquí...", author: "Tu nombre" }, // this flesh is a tomb - atreyu
    { url: "https://open.spotify.com/embed/track/03IARX7s1aJZlDDvn8mJ2Z", message: "Mensaje aquí...", author: "Tu nombre" }  // forever and always - bullet for my valentine
];

const container = document.getElementById('playlist-container');

mixtape.forEach(item => {
    // Verificamos si el elemento es un título separador o una canción
    if (item.isHeader) {
        const header = document.createElement(item.level === 1 ? 'h2' : 'h3');
        header.className = item.level === 1 ? 'side-title' : 'phase-title';
        ...
        card.innerHTML = `
            ...
            <div class="message-box">
                ...
                <p class="message-author">- ${item.author}</p>
            </div>
        `;
